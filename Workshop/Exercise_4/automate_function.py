...
import Utilities.morta as morta
...
def automate_function_morta(
    ...
    # read the rules from Morta table view
    rules = morta.read_rules_from_morta_table_view("", "90b29bc7-72c2-48f4-b764-348fc865773b")
